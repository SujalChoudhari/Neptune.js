 ...
 * ======
 * @class Color
 * @classdesc A class that represents a color.  It can be used to create colors, manipulate colors, and convert colors to hexadecimal.
 * 
 * Properties:
 * -----------
 * @property r - The red value of the color.
 * @property g - The green value of the color.
 * @property b - The blue value of the color.
 * @property a - The alpha value of the color.
 * 
 * Methods:
 * --------
 * @method random - Create a random color.
 * @method  fromHex - Create a color from a hex value.
 * @method fromRGB - Create a color from an rgb value.
 * @method fromRGBA - Create a color from an rgba value.
 * @method fromHSL - Create a color from an hsl value.
 * 
 */
export default class Color {
     ...
     * Get Color from Hex
     * @static
     * @param {Number} hex - The hex value of the color.(0x000000)
     * @returns {Color} - The color in rgb format.
     */
    static fromHex(hex) {
        let r = hex >> 16 & 255;
        let g = hex >> 8 & 255;
     ...
     * @param {Number} b - The blue value of the color.
     * @param {Number} a - The alpha value of the color.
     * @returns {Color} - The color in rgba format.
     */
     ...
     * Get Color from HSL
     * @static
     * @param {Number} h - The hue value of the color.
     * @param {Number} s - The saturation value of the color.
     * @param {Number} l - The lightness value of the color.
     * @returns {Color} - The color in hsl format.
     */
